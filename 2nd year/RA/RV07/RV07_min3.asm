...
; funkcije za primerjavo -------------------------------------------------------------------------------
min3:
cmp rdi, rsi                                    ; izvedemo compare med prvima dvema stevilma
jge .tretje_drugo                               ; ce je drugi manjsi izvedemo to funkcijo
cmp rdi, rdx                                    ; izvedemo compare med prvim in tretjim
jge .tretje_drugo                               ; ce je tretji (od teh drugi) manjsi izvedemo to funkcijo
mov rax, rdi                                    ; prvo je najmanjse in ga shranimo v rdi
ret                                             ; vrnemu se iz funkcije

.tretje_drugo:                                  ; primerjava druge in tretje
cmp rsi, rdx
jge .tretje                                     ; ce je tretja manjsa gremo v posebej funkcijo
mov rax, rsi                                    ; drugo je najmanjse in ga shranimo v rdi
ret

.tretje:                                        ; posebej funkcija za tretjo
mov rax, rdx                                    ; tretja je najmanjsa in jo shranimo v rdi
ret