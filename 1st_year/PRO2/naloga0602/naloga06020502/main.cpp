...
int main() {
    ...
    ColorTask* ct2 = new ColorTask(Color::blue, "Moder", "Moder colortask", datum1);
    ColorTask* ct3 = new ColorTask(Color::green, "Zelen", "Zelen colortask", datum1);
    ColorTask* ct4 = new ColorTask(Color(25,30,2), "cetrta", "cetrti colortask", datum1);
    ColorTask* ct5 = new ColorTask(Color(255,30,2), "peti", "peti colortask", datum1);
   ...
   /* tabla->addTask("Kategorija1", t1);
    ...
    tabla->addTask("Kategorija1", ct4);
    tabla->addTask("Kategorija1", ct5);
